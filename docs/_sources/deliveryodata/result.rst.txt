...
..  od:feed::   Results Result
    ...
    ..  od:action:: FetchPurgeRetentionPeriodDays Edm.Int32
        
        .. versionadded::   2024.10

        If a retention policy has been set for the tenant then the
        value, in days, is returned.  Otherwise a 404 error is returned
...
..  od:type::   Result
    ...
    ..  od:prop::   Language Edm.String
        ...
        The language of the assessment presented to the Participant.
    ...
    ..  od:prop::   ExternalResultID Edm.String
    
        .. versionadded::   2024.04

        Used to hold a reference to the result in a related data source,
        may be used by Questionmark technical support for
        troubleshooting.  For a result generated by an Advanced
        Assessments this field is used to hold a reference to the
        session data.  Limited availability.

    ..  od:prop::   ExternalResultInfo Edm.String
    
        .. versionadded::   2024.08

        Used to hold additional information related to this result
        retrieved from a related data source.  Limited availability.
